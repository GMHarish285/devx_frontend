  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-black p-6">
          ...
          <ul className="flex space-x-6">
            <li>
              <button
                ...
                onClick={() => window.location.href = "https://reacttestbackend.onrender.com/auth/login"}
              >
                Sign up/Sign in
                <svg
      ...
      <section className="flex flex-col items-center justify-center flex-grow text-center px-6 py-32">
        ...
        <button className="animate__animated animate__rubberBand mt-6 bg-blue-600 text-white px-8 py-3 text-lg font-semibold rounded-lg shadow-md hover:bg-blue-700 transition transform hover:scale-105 duration-200" onClick={() => window.location.href = "https://reacttestbackend.onrender.com/auth/login"}>
          Get Started
        </button>
      </section>
    </div>
